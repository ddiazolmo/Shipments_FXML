...
public class ControllerFormShipments implements Initializable, ChangeListener<Pair<String, String>> {
	@FXML
	...
	protected void loadOffices(ComboBox<Office> combo) {
		...
		combo.setItems(FXCollections.observableArrayList(offices));
